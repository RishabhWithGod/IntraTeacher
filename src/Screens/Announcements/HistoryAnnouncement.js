      ...
      {filterbooks.map((book, index) => (
        <View key={index}>
          <TouchableOpacity
            ...
            onPress={() => {
              console.log("data=" + JSON.stringify(books[index]));
              props.navigation.navigate('HistoryDetailAnn', { books: books[index] })
          }}>
            <View>
              <Text
                style={{
            ...
            <View>
              ...
              <Text
                style={{color: '#000000',fontSize: 12, fontFamily: 'Montserrat-Regular'}}>
                {book.date}
              </Text>
            </View>
          </TouchableOpacity>
