...
import { View, Text, Button, StyleSheet, StatusBar, TextInput, TouchableOpacity,ScrollView, } from 'react-native';
            ...
            {filtersubjects.map((sub, index) => (
                <View key={index}>
                    ...
                    onPress={() => {
                      ...
                      props.navigation.navigate('HistoryDetailTest', { subjects: subjects[index] })
                  }}
                  >

                        <View>

                            <Text style={{ color: '#000000',fontSize: 13, fontFamily: 'Montserrat-SemiBold', }}>{sub.subname}</Text>
                          
                        </View>
                        <View>
                        <Text style={{ color: '#000000', fontSize: 12, fontFamily: 'Montserrat-SemiBold', }}>{sub.stream}</Text>
